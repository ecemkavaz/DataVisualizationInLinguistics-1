...
def inject_text_conversation(session_id, textMsg):
    url = 'http://152.42.143.156:5005/conversations/' + session_id + '/trigger_intent?token=DataVisualizationInLinguisticsSecretToken&include_events=NONE&output_channel=socketio'
    json_msg = {
